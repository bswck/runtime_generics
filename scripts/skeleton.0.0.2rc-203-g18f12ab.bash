...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/0.0.2rc-203-g18f12ab).
#
# This file was generated from bswck/skeleton@0.0.2rc-203-g18f12ab.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/0.0.2rc-203-g18f12ab/project/scripts/skeleton.%7B%7Bsref%7D%7D.bash.jinja
#
# Usage:
#
...
make_context() {
	...
	export PYPI_URL
	PYPI_URL=$(cat <<- 'EOF'
		https://pypi.org/project/runtime-generics/
	EOF
	)
	export TIDELIFT_URL
	TIDELIFT_URL=$(cat <<- 'EOF'
		https://tidelift.com/subscription/pkg/pypi-runtime-generics?utm_source=pypi-runtime-generics
	EOF
	)
	export SKELETON
	SKELETON=$(cat <<- 'EOF'
	...
	SKELETON_REV=$(cat <<- 'EOF'
		https://github.com/bswck/skeleton/tree/0.0.2rc-203-g18f12ab
	EOF
	)
	export SREV
	SREV=$(cat <<- 'EOF'
	...
	SKELETON_AND_REF=$(cat <<- 'EOF'
		bswck/skeleton@0.0.2rc-203-g18f12ab
	EOF
	)
	export SNREF
	SNREF=$(cat <<- 'EOF'
	...
	GH_REPO_ARGS=$(cat <<- 'EOF'
		"bswck/runtime_generics" --public --source=./ --remote=upstream --description="Reuse generic class type arguments at runtime."
	EOF
	)
    ...
    export LAST_REF="0.0.2rc-203-g18f12ab"
