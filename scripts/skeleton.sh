...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/d097ca9).
#
# This file was generated from bswck/skeleton@d097ca9.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/d097ca9/project/scripts/skeleton.sh.jinja
#
# Usage:
#
...
# Automatically copied from https://github.com/bswck/skeleton/tree/d097ca9/handle-task-event.sh
setup_gh() {
