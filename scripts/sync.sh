...
# This script was adopted from https://github.com/bswck/skeleton/tree/7bb2aa5/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/7bb2aa5/handle-task-event.sh
