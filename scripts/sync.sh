...
# This script was adopted from https://github.com/bswck/skeleton/tree/99506cd/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/99506cd/handle-task-event.sh
