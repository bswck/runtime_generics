...
# Script adopted from https://github.com/bswck/skeleton/tree/eec6850/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync


# Automatically copied from https://github.com/bswck/skeleton/tree/eec6850/handle-task-event.sh
