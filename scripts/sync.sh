...
# This script was adopted from https://github.com/bswck/skeleton/tree/33acf49/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/33acf49/handle-task-event.sh
