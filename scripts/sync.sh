...
# This script was adopted from https://github.com/bswck/skeleton/tree/5d04f93/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/5d04f93/handle-task-event.sh
