...
# This script was adopted from https://github.com/bswck/skeleton/tree/266ebd0/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/266ebd0/handle-task-event.sh
