...
# This script was adopted from https://github.com/bswck/skeleton/tree/bb13b3b/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/bb13b3b/handle-task-event.sh
