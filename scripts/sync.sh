...
# Script adopted from https://github.com/bswck/skeleton/tree/fd74ecf/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync


# Automatically copied from https://github.com/bswck/skeleton/tree/fd74ecf/handle-task-event.sh
