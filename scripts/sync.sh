...
# This script was adopted from https://github.com/bswck/skeleton/tree/678468f/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync
...
# Automatically copied from https://github.com/bswck/skeleton/tree/678468f/handle-task-event.sh
