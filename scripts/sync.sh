...
# Script adopted from https://github.com/bswck/skeleton/tree/546e851/project/scripts/sync.sh.jinja
#
# Usage:
# $ poe sync


# Automatically copied from https://github.com/bswck/skeleton/tree/546e851/handle-task-event.sh
